...
namespace MetricsManager.Controllers
{
    public class HardDriveMetricsController : BaseMetricsController<HardDriveMetricsController, HardDriveMetricAgent>
    {
        ...
        /// <summary>
        /// Получает метрики HardDrive агента с указанным идентификатором на заданном диапазоне времени
        /// </summary>
        ...
        /// <summary>
        /// Получает метрики HardDrive всех агентов на заданном диапазоне времени
        /// </summary>
        /// <param name="fromTime">начальная метка времени</param>
        /// <param name="toTime">конечная метка времени</param>
